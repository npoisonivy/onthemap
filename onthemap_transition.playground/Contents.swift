...
// not this one - let request = NSMutableURLRequest(url: NSURL(string: "https://api.parse.com/1/classes/StudentLocation")! as URL)  // it would say "Parse.com has shutdown - https://parseplatform.github.io/"
...
// when adding to real life code. make sure below firstname is not optional(xxx)
let firstname = "John"
let lastname = "Way"
let uniqueKey = "5555"
...
//}
//task.resume()
// successful result - {"user": {"bio": null, "_registered": true,
// failed result - {"status": 404, "error": "Not found: Key('Account', 3903878
//
//
///
//// POSTing a Session - WITHOUT FACEBOOK
//// = getUserID() in the app
...
//task.resume()
//10600060877
// successful return (my account) - {"account": {"registered": true, "key": "116975484"},
// successful return - {"account":{"registered":true, "key":"3903878747"}, "session":{"id":"1457628510Sc18f2ad4cd3fb317fb8e028488694088", "expiration":"2015-05-10T16:48:30.760460Z"}}
// b4, posting HTTP, failed return - {"status": 403, "error": "Account not found or invalid credentia
// after posting, "account": {"registered": false, "key": "10600060877"}
